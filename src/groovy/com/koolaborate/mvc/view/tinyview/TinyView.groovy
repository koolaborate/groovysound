...
public class TinyView extends JWindow
{
	...
	CoverPanel cover
	Playlist playlist
	JPanel controlPanel, bg
	int translateY = 0
	int panelHeight = 40
	int animationDuration = 800 // for 0.8 seconds
	Timer outTimer, inTimer, animStartTime, fadeInStartTime
	boolean panelIsVisible = false
	
	JLabel songLabel, artistLabel
	ImageIcon playIcon, pauseIcon, stopIcon, prevIcon, nextIcon
	...
	JButton playButton
	PlaybackController playerPanel
