...
import helper.AmazonWebServiceUtils;
 ...
 ***********************************************************************************/
public class SearchNewCoverFrame extends JDialog
{
	...
	private void searchCovers()
	{
		...
		Thread t1 = new Thread(new Runnable(){
			public void run()
			{
				...
				try
				{
					i1 = AmazonWebServiceUtils.getAlbumArtImg(artist, album);
				}
				catch(Exception e)
				{
