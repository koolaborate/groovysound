...
import ui.navigation.NavButton;
import ui.navigation.Separator;
	...
	public static JPanel createNavigationBackgroundPanel()
	{
		...
		final JPanel navigationBackgroundPanel = new JPanel(){
			...
			protected void paintComponent(Graphics g)
			{
			    ...
			    LinearGradientPaint gp2 = new LinearGradientPaint(new Point(0, 0), new Point(0, getHeight()), dist2, colors2, 
			    		CycleMethod.NO_CYCLE);
