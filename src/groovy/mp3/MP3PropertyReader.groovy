...
//				System.out.println("----------------------------");
//				System.out.println("Interpret: " + properties.get("author"));
//				System.out.println("Titel:     " + properties.get("title"));
//				
//				long duration = (Long)properties.get("duration");
//				long min = duration / (1000000*60);
//				long sec = duration % (1000000*60);
//					
//				System.out.println("Länge:     " + min + ":" + sec + " min");
//				
//				int channels = (Integer)properties.get("mp3.channels");
//				String monoStereo = "mono";
//				if(channels == 2) monoStereo = "stereo";
//				
//				System.out.println("Kanäle:    " + monoStereo);
//				
//				int frequency = (Integer)properties.get("mp3.frequency.hz");
//				
//				System.out.println("Frequenz:  " + frequency + " Hz");
//				
//				System.out.println("Album:     " + properties.get("album"));
//				System.out.println("Jahr:      " + properties.get("date"));
//				
//				System.out.println("----------------------------");
